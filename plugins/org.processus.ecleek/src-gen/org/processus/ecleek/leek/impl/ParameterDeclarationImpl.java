 ...
 *   <li>{@link org.processus.ecleek.leek.impl.ParameterDeclarationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterDeclarationImpl extends MinimalEObjectImpl.Container implements ParameterDeclaration
{
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LeekPackage.PARAMETER_DECLARATION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LeekPackage.PARAMETER_DECLARATION__BY_ADRESS:
        return isByAdress();
      case LeekPackage.PARAMETER_DECLARATION__NAME:
        return getName();
    }
