 ...
 * <ul>
 *   <li>{@link org.processus.ecleek.leek.impl.StatementBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatementBlockImpl extends StatementImpl implements StatementBlock
{
  ...
  {
    return LeekPackage.Literals.STATEMENT_BLOCK;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, LeekPackage.STATEMENT_BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LeekPackage.STATEMENT_BLOCK__STATEMENTS:
