 ...
 *   <li>{@link org.processus.ecleek.leek.ParameterDeclaration#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ParameterDeclaration extends EObject
{
   ...
   * @see #setName(String)
   * @see org.processus.ecleek.leek.LeekPackage#getParameterDeclaration_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.processus.ecleek.leek.ParameterDeclaration#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
