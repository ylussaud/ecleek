		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAffectationStatementAccess().getAlternatives(), "rule__AffectationStatement__Alternatives");
					put(grammarAccess.getAffectationPostfixStatementAccess().getAlternatives_1(), "rule__AffectationPostfixStatement__Alternatives_1");
					put(grammarAccess.getAffectationPrefixStatementAccess().getAlternatives_0(), "rule__AffectationPrefixStatement__Alternatives_0");
					...
					put(grammarAccess.getForAffectationAccess().getAlternatives(), "rule__ForAffectation__Alternatives");
					...
					put(grammarAccess.getPrefixAccess().getAlternatives_0(), "rule__Prefix__Alternatives_0");
					...
					put(grammarAccess.getAffectationDecrementAccess().getGroup(), "rule__AffectationDecrement__Group__0");
					put(grammarAccess.getAffectationIncrementAccess().getGroup(), "rule__AffectationIncrement__Group__0");
					put(grammarAccess.getAffectationPostfixStatementAccess().getGroup(), "rule__AffectationPostfixStatement__Group__0");
					put(grammarAccess.getAffectationPostfixStatementAccess().getGroup_1_0(), "rule__AffectationPostfixStatement__Group_1_0__0");
					put(grammarAccess.getAffectationPostfixStatementAccess().getGroup_1_1(), "rule__AffectationPostfixStatement__Group_1_1__0");
					put(grammarAccess.getAffectationPrefixStatementAccess().getGroup(), "rule__AffectationPrefixStatement__Group__0");
					put(grammarAccess.getAffectationPrefixStatementAccess().getGroup_0_0(), "rule__AffectationPrefixStatement__Group_0_0__0");
					put(grammarAccess.getAffectationPrefixStatementAccess().getGroup_0_1(), "rule__AffectationPrefixStatement__Group_0_1__0");
					...
					put(grammarAccess.getForInitializerAccess().getGroup_0(), "rule__ForInitializer__Group_0__0");
					...
					put(grammarAccess.getVariableDeclarationWithValueAccess().getGroup(), "rule__VariableDeclarationWithValue__Group__0");
					...
					put(grammarAccess.getTernaryIfAccess().getGroup(), "rule__TernaryIf__Group__0");
					put(grammarAccess.getTernaryIfAccess().getGroup_1(), "rule__TernaryIf__Group_1__0");
					...
					put(grammarAccess.getPrefixAccess().getGroup_0_0(), "rule__Prefix__Group_0_0__0");
					put(grammarAccess.getPrefixAccess().getGroup_0_1(), "rule__Prefix__Group_0_1__0");
					put(grammarAccess.getVariableReferenceArrayAccess().getGroup(), "rule__VariableReferenceArray__Group__0");
					put(grammarAccess.getVariableReferenceArrayAccess().getGroup_1(), "rule__VariableReferenceArray__Group_1__0");
					...
					put(grammarAccess.getAffectationDecrementAccess().getVariableAssignment_0(), "rule__AffectationDecrement__VariableAssignment_0");
					put(grammarAccess.getAffectationDecrementAccess().getDecrementAssignment_2(), "rule__AffectationDecrement__DecrementAssignment_2");
					put(grammarAccess.getAffectationIncrementAccess().getVariableAssignment_0(), "rule__AffectationIncrement__VariableAssignment_0");
					put(grammarAccess.getAffectationIncrementAccess().getIncrementAssignment_2(), "rule__AffectationIncrement__IncrementAssignment_2");
					put(grammarAccess.getAffectationPrefixStatementAccess().getRightAssignment_1(), "rule__AffectationPrefixStatement__RightAssignment_1");
					...
					put(grammarAccess.getVariableDeclarationWithValueAccess().getNameAssignment_0(), "rule__VariableDeclarationWithValue__NameAssignment_0");
					put(grammarAccess.getVariableDeclarationWithValueAccess().getValueAssignment_2(), "rule__VariableDeclarationWithValue__ValueAssignment_2");
					put(grammarAccess.getVariableDeclarationUnitializedAccess().getNameAssignment(), "rule__VariableDeclarationUnitialized__NameAssignment");
					...
					put(grammarAccess.getTernaryIfAccess().getThenAssignment_1_2(), "rule__TernaryIf__ThenAssignment_1_2");
					put(grammarAccess.getTernaryIfAccess().getElseAssignment_1_4(), "rule__TernaryIf__ElseAssignment_1_4");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getValueAssignment_8_1(), "rule__PrimaryExpression__ValueAssignment_8_1");
					...
					put(grammarAccess.getPrefixAccess().getRightAssignment_1(), "rule__Prefix__RightAssignment_1");
					...
					put(grammarAccess.getVariableReferenceArrayAccess().getVariableAssignment_0(), "rule__VariableReferenceArray__VariableAssignment_0");
					put(grammarAccess.getVariableReferenceArrayAccess().getDimensionsAssignment_1_1(), "rule__VariableReferenceArray__DimensionsAssignment_1_1");
